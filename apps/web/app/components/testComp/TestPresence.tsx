...
export default function TestPresence({ userId }: { userId: string }) {
    ...
    <div style={{ marginTop: 40, padding: 20 }}>
      ...
      {notifications.map((n, i) => (
        ...
        >
          ...
          <div>
            <strong>From:</strong> {n.actorId}
          </div>
          <div>
            <strong>Task:</strong> {n.entityId}
          </div>
          <div>
            <strong>creator</strong> {n.creator}
          </div>
          <div>
            <strong>info:</strong> {JSON.stringify(n.info)}
          </div>
          <div>
            <strong>info:</strong> {JSON.stringify(n.mentionedIds)}
          </div>
        </div>
      ))}
    </div>
