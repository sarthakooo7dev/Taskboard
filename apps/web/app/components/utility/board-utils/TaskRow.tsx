  ...
  return (
    ...
    >
      ...
      <div className=" flex items-center justify-center px-2">
        <Select value={task.column.id} onValueChange={handleStatusUpdate}>
      ...
      <div className=" flex items-center px-2 ">
        <div className="flex w-full items-center gap-2">
          <div className="h-[6px] min-w-0 flex-1 overflow-hidden rounded-full border border-lg_grey">
            <div
              className="h-full rounded-full bg-green-400/70 transition-all duration-300"
      ...
      <div className=" flex items-center justify-end ">
        <div
          className={`inline-flex  rounded-md px-2 py-[2px] text-[10px] mr-2 tracking-widest ${
      ...
      <div className="flex items-center justify-center">
        <Popover>
          <PopoverTrigger asChild>
            <button
              className="rounded-md p-1.5 text-gray-400 disabled:text-gray-700"
          ...
          <PopoverContent
            side="bottom"
            align="end"
            className="z-50 w-[120px] rounded-md border border-white/[0.06] bg-dk_grey p-1 shadow-2xl shadow-black/30"
          >
            <div className="flex flex-col">
              {/* EDIT */}
              <button
                className="flex items-center gap-2 rounded-lg px-3 py-2 text-xs tracking-wider text-gray-300 transition-colors duration-200 hover:bg-lg_grey/30"
