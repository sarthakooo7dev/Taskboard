...
export default function Sidebar() {
  ...
  return (
    <aside className="max-w-[14rem] shrink-0  bg-dk_grey p-2 flex flex-col  border-r border-r-dk_border  overflow-y-auto minimal-scrollbar">
      {/*  SECTION 1: LOGO + SEARCH  */}
      <div className=" ">
        {/* Logo / Workspace */}
        <div
          className="flex items-center justify-between cursor-pointer p-2 border-2 border-dk_border rounded-md mb-5 "
          onClick={handleLogoCard}
        >
          ...
          <div className="flex-1 ml-2 ">
            <p className="text-sm font-bold tracking-[3px] text-gray-300">
              KLYRO
            </p>
